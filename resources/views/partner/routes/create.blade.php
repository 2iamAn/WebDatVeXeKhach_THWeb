...
<div class="page-header">
    ...
    <p class="text-muted mb-0 mt-2">Tạo tuyến đường mới cho nhà xe</p>
</div>

<div class="card shadow-sm border-0" style="border-radius: 15px;">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('partner.routes.store') }}">
            @csrf
